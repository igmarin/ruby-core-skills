...
- [ ] `rails-agent-skills` `directory.json` contains exactly the 37 skills listed in Section 2 (under `"skills"`)
- [ ] `hanakai-yaku` `directory.json` contains exactly the 45 skills listed in Section 3 (under `"skills"`)
- [ ] `agnostic-planning-skills` `directory.json` contains exactly the 14 skills listed in Section 4 (under `"skills"`)
- [ ] `ruby-core-skills` `directory.json` contains exactly the 16 skills listed in Section 1 (under `"skills"`)
